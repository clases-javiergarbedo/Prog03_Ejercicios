...
public class TrianguloAsteriscos extends javax.swing.JFrame {

    public TrianguloAsteriscos() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(tamano>3 && tamano<15) {
            ...
            jTextArea1.setText("Debes indicar un tamaño mayor que 3 y menor que 15");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrianguloAsteriscos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrianguloAsteriscos().setVisible(true);
            }
        });
    }
